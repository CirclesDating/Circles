import Style from './StyleSheets/ConversationsScreen'
import React, {Component} from 'react'
import {Text, View, FlatList, SafeAreaView, Image, ST} from 'react-native'
    ...
    render(){
        return(
            <View style={styles.mainAdventuresStyle}>
                ...
                <Text style = {styles.ActiveAdventures} >Matches</Text>
